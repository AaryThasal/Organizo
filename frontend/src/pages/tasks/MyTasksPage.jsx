    ...
    return (
        <div className="animate-fade-in">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                {[
                    { status: 'to-do', label: 'To Do', color: 'bg-dark-elevated text-text-secondary' },
                    { status: 'in-progress', label: 'In Progress', color: 'bg-info/10 text-blue-400' },
                    { status: 'completed', label: 'Completed', color: 'bg-success/10 text-green-400' },
                    { status: 'on-hold', label: 'On Hold', color: 'bg-warning/10 text-amber-400' },
                ].map((item) => (
                    <button
                        key={item.status}
                        ...
                        <div key={projectName} className="card">
                            ...
                            <div className="space-y-3">
                                {tasks.map((task) => (
                                    <div
                                        key={task.id}
                                        className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-4 rounded-xl bg-dark-elevated"
                                    >
                                        ...
                                        <div className="flex items-center gap-2">
                                            <select
                                                ...
                                                className="text-sm border border-dark-border rounded-lg px-3 py-2 bg-dark-card text-text-primary focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 cursor-pointer"
                                            >
