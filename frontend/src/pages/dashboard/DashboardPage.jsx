        ...
        <div className="animate-fade-in">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="card">
                    ...
                    {projects.length === 0 ? (
                        <p className="text-secondary-500 text-center py-8">No projects yet</p>
                    ) : (
                ...
                {user?.role === 'employee' ? (
                    <div className="card">
                        <div className="flex items-center justify-between mb-4">
                            <h2 className="text-lg font-semibold text-secondary-900">My Tasks</h2>
                        ...
                        {myTasks.length === 0 ? (
                            <p className="text-secondary-500 text-center py-8">No tasks assigned</p>
                        ) : (
                            <div className="space-y-3">
                                {myTasks.slice(0, 5).map((task) => (
                                    ...
                                    >
                                        <div>
                                            ...
                                            <p className="text-xs text-secondary-500">{task.project_name}</p>
                                        </div>
                    ...
                    <div className="card">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <Link
                                to="/projects"
                                className="p-4 rounded-xl border-2 border-dashed border-secondary-200 hover:border-primary-300 hover:bg-primary-50 transition-all text-center"
                            >
                                <svg className="w-8 h-8 text-secondary-400 mx-auto mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                                </svg>
                                <p className="text-sm font-medium text-secondary-700">New Project</p>
                            </Link>
                            <Link
                                to="/employees"
                                className="p-4 rounded-xl border-2 border-dashed border-secondary-200 hover:border-primary-300 hover:bg-primary-50 transition-all text-center"
                            >
                                ...
                                <p className="text-sm font-medium text-secondary-700">View Team</p>
                            </Link>
                            {user?.role === 'admin' && (
                                <>
                                    <Link
                                    ...
                                    >
                                        ...
                                        <p className="text-sm font-medium text-secondary-700">Pending Requests</p>
                                    </Link>
                                    <Link
                                        to="/settings"
                                        className="p-4 rounded-xl border-2 border-dashed border-secondary-200 hover:border-primary-300 hover:bg-primary-50 transition-all text-center"
                                    >
                                        ...
                                        <p className="text-sm font-medium text-secondary-700">Settings</p>
                                    </Link>
                                </>
                            )}
                        </div>
